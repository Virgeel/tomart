...
<div style="padding-left:50px;padding-top:20px;">
    ...
    <div class="column">
        ...
        <a class="row {{Request::is('dashboard') ? 'active' : ''}}" aria-current="page" href="/dashboard" style="text-decoration:none;">
        ...
        <a class="row {{Request::is('dashboard/produk*') ? 'active' : ''}}" href ="/dashboard/produk" style="text-decoration:none;">
            <iconify-icon icon="game-icons:tomato" height="30" style=""></iconify-icon>
            <div style="padding-left : 10px;font-family:Poppins;font-size:18;font-weight:bold;">
            Produk</div>
            </a>
        <a class="row {{Request::is('dashboard/pegawai*') ? 'active' : ''}}" href="/dashboard/pegawai" style="text-decoration:none;">
            <iconify-icon icon="fluent:people-community-24-filled" height="30" style=""></iconify-icon>
            <div style="padding-left : 10px;font-family:Poppins;font-size:18;font-weight:bold;">
            Pegawai</div>
            </a>
            
        <a class="row {{Request::is('dashboard/stok*') ? 'active' : ''}}" href="/dashboard/stok" style="text-decoration:none;">
